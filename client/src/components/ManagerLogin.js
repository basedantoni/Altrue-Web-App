...
class ManagerLogin extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    if (nextProps.auth.isAuthenticated) {
      this.props.history.push("/managerDashboard"); //push user to dashboard when logging in
    }
  ...
  onSubmit = e => {
    ...
    this.props.loginManager(userData); // since we handle the redirect within our component, we don't need to pass in this.props.history as a parameter
  }
